...
5. *Have a working microphone in your machine*: For testing out our model. we will record audio in real time and feed it to our model to make a prediction. Please ensure that you have a working microphone in your machine. External microphones can be used if needed.
